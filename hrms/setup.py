...
def get_custom_fields():
	...
	return {
		"Company": [
			...
			{
				"depends_on": "eval:!doc.__islocal",
				"fieldname": "default_piutang_karyawan_account",
				"fieldtype": "Link",
				"ignore_user_permissions": 1,
				"label": "Default Piutang Karyawan Account",
				"no_copy": 1,
				"options": "Account",
			...
			{
				"depends_on": "eval:!doc.__islocal",
				"fieldname": "default_income_tax_payable_account",
				"fieldtype": "Link",
				"ignore_user_permissions": 1,
				"label": "Default Income Tax Payable Account",
				"no_copy": 1,
				"options": "Account",
				"insert_after": "default_piutang_karyawan_account",
			},
			{
				"depends_on": "eval:!doc.__islocal",
				"fieldname": "default_bpjstk_payable_account",
				"fieldtype": "Link",
				"ignore_user_permissions": 1,
				"label": "Default BPJS Ketenagakerjaan Account",
				"no_copy": 1,
				"options": "Account",
				"insert_after": "default_income_tax_payable_account",
			},
			{
				"depends_on": "eval:!doc.__islocal",
				"fieldname": "default_bpjstk_expense_account",
				"fieldtype": "Link",
				"ignore_user_permissions": 1,
				"label": "Default BPJS Ketenagakerjaan Expense Account",
				"no_copy": 1,
				"options": "Account",
			},
		],
